package com.example.capturebehavioral.framework
...
class FirebaseDatabase: OnFirebase {
    ...
    private val database = Firebase.database(("https://capturevoice-913ec-default-rtdb.europe-west1.firebasedatabase.app"))
    val myRef = database.getReference("users")

    override fun saveAudio(audio: Audio): Flow<Response<Any>> = callbackFlow {
        val storage = Firebase.storage
        val storageRef = storage.reference.child( "captureBehavioral/${audio.sesion}/${audio.nameAudio}.wav")
